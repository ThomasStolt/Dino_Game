...
void showStartScreen() {
  ...
  // Draw the image from the startScreenImageData array
  int imgWidth = 280;  // Replace with actual width of your image
  int imgHeight = 240; // Replace with actual height of your image

  for (int y = 0; y < imgHeight; y++) {
    for (int x = 0; x < imgWidth; x++) {
      uint16_t color = DinoSkaliert[y * imgWidth + x];
